...
import { exportOMRTemplate } from '../omr-exporter/service.js';
...
export function renderPrintUI(container) {
  ...
  // Nota: el botón "Volver a Impresión" del paso OMR Reader se conecta
  // directamente en omr-reader/controller.js (antes se intentaba buscar
  // aquí con `document.getElementById('omr-back-btn')`, pero ese elemento
  // todavía no existía en el DOM en el momento en que esta función se
  // ejecuta durante el arranque de la app — initPrinter() corre antes que
  // initOMRReader() — así que el botón nunca quedaba conectado).
